...
#
# Generated by Vivado on Thu Aug 03 10:01:57 -0400 2017
...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/College/Thesis/VivadoProjects/AES_encrypt/AES_encrypt/AES_encrypt.cache/compile_simlib/activehdl"
  fi
