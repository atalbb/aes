...
#
# Generated by export_simulation on Wed Sep 12 14:22:15 -0400 2018
#
################################################################################
...
switch to the './key_mem_gen_0.sh' script.

./key_mem_gen_0.sh -reset_run
...
./key_mem_gen_0.sh -noclean_files

For more information on the script, please type './key_mem_gen_0.sh -help'.
