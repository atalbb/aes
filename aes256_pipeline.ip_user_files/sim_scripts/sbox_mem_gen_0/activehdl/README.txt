...
#
# Generated by export_simulation on Wed Sep 12 12:26:50 -0400 2018
#
################################################################################
...
switch to the './sbox_mem_gen_0.sh' script.

./sbox_mem_gen_0.sh -reset_run
...
./sbox_mem_gen_0.sh -noclean_files

For more information on the script, please type './sbox_mem_gen_0.sh -help'.
