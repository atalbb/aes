...
#
# Generated by export_simulation on Wed Sep 12 18:40:22 -0400 2018
#
################################################################################
...
switch to the './invSbox_mem_gen_0.sh' script.

./invSbox_mem_gen_0.sh -reset_run
...
./invSbox_mem_gen_0.sh -noclean_files

For more information on the script, please type './invSbox_mem_gen_0.sh -help'.
