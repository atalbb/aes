...
HD_PWD='C:/College/Thesis/AES_2018/AES_After 9_10_2018/aes256_pipeline/aes256_pipeline.runs/invSbox_mem_gen_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log invSbox_mem_gen_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source invSbox_mem_gen_0.tcl
