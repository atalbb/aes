...
#
# Generated by export_simulation on Thu Sep 06 16:48:45 -0400 2018
#
################################################################################
...
switch to the './data_mem_gen_0.sh' script.

./data_mem_gen_0.sh -reset_run
...
./data_mem_gen_0.sh -noclean_files

For more information on the script, please type './data_mem_gen_0.sh -help'.
